...
const selectedMethod = ref(props.expense.method);
        ...
        <div class="flex justify-center">
            ...
            <section class=" w-[48rem] mx-12 mt-[3rem] pb-6 rounded-[1rem] border border-gray-300 bg-white">
                <div class="flex justify-between items-center">
                    <div class="m-8 text-[1.2rem] font-medium">Ausgabe Bearbeiten</div>
                ...
                <form @submit.prevent="form.patch(route('expense.update', { id: form.id }))" class="px-8 flex flex-col space-y-6">
                    ...
                    <div class="w-full flex justify-center items-center">
                        <div class="w-[20.5rem] rounded-[1rem] border border-gray-500">
                            ...
                            <select id="category" v-model="form.category_id" class="border-none rounded-[1rem] w-full outline-none text-[1rem] focus:ring-transparent placeholder:text-gray-200">
                                ...
                                <option v-for="category in $page.props.categories" :key="category.id" :value="category.id" :selected="category.name === $page.props.expense.category_name">
                                    {{ category.name }}
                                </option>
                            </select>
            ...
            'bg-green-400 text-black': selectedMethod === 'Bargeld',
                                ...
                                <div
                                    ...
                                    :class="{
            'bg-blue-400 text-black': selectedMethod === 'Karte',
          }"
