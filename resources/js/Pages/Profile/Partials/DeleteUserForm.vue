        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="p-6">
                <h2 class="text-lg font-medium text-gray-900">
                    Sicher, dass das Konto gelöscht werden soll?
                </h2>

                <p class="mt-1 text-sm text-gray-600">
                    Wenn das Konto gelöscht ist, sind alle damit verbundenen Daten unwiderruflich verloren.
                </p>

                <div class="mt-6">
                    <InputLabel for="password" value="Passwort" class="sr-only" />
